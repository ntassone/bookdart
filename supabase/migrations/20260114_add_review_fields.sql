...
ALTER TABLE user_books
  ADD COLUMN is_review_public BOOLEAN DEFAULT false NOT NULL,
  ADD COLUMN read_count INTEGER DEFAULT 1 CHECK (read_count >= 1);

-- Add index for efficient public review queries
-- This partial index only indexes rows that are actual public reviews
CREATE INDEX idx_user_books_public_reviews
